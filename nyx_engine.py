...
class NYX(App):
    """
    NYX-CAT // SOVEREIGN_KERNEL // STABLE_STRICT
    - Layout: Manual Dashboard Header (Custom).
    - Logic: Phi-3 Inference Engine.
    """
    ...
    def compose(self) -> ComposeResult:
        yield Static("NYX-CAT // SOVEREIGN ARCHITECT // ENTERPRISE v12.2", id="header_bar")
        yield Log(id="log")
    ...
    def on_mount(self) -> None:
        ...
        # CPU-Optimized Pipeline initialization
        ...
        log.write(f">> SYSTEM READY. DEVICE: {self.device.upper()}")
    ...
    def on_input_submitted(self, event: Input.Submitted) -> None:
        ...
        # Stripping the prompt from the response
